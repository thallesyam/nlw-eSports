    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg max-w-[550px] shadow-lg shadow-black/25">
